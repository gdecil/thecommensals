...
var xDirectives = angular.module('xDirectives', ['ui.layout']);

xDirectives.directive('angledNavbar',function(){
  return {
    restrict : 'AE',
    scope : {
      brand : '=',
...
xDirectives.directive('angledNavbar1',function(){
  return {
    restrict : 'AE',
    scope : {
      brand : '=',
...
xDirectives.directive('angledNavbar2',function(){
  return {
    restrict : 'AE',
    scope : {
      brand : '=',
